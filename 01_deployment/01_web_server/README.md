...
여기는 ACIN Academy에서 제공하는 Open Courses 중에서 `ACIN-201 Service Deployment (서비스 배포)`에 중에서 딥러닝 서비스 배포를 준비하기 위한 web server 구축에 대한 강의를 정리한 페이지 입니다.

주된 내용은 딥러닝 기능을 개발한 이후, 관련 서비스를 배포하기 위한 `웹 시스템을 구축`하는 강의입니다.
