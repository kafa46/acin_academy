...
|---|---|---|---|---|
|OT|01. Orientation|[click](https://youtu.be/Q7SqTAH0pHk)|[link](https://github.com/kafa46/acin_academy/blob/master/202_fine_tunning/whisper/01_orientation.pdf)|없음|
...
|전처리|09. 학습데이터를 Train/Test set으로 분할하는 기능 구현|[click]()|없음|없음|
|전처리|10. Train/test set 분할 기능을 argparse에 등록하기|[click]()|없음|없음|
